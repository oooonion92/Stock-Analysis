...
export type StructureScope = "stroke" | "segment";

export interface StructureLineMetrics {
  name: string;
  startTime: string;
  endTime: string;
  startValue: number;
...
export interface StructureComparison {
  ...
  direction: "up" | "down";
  reference: StructureLineMetrics | null;
  test: StructureLineMetrics;
...
export interface AnalysisResponse {
  ...
  viewport_bar_start: string;
  viewport_bar_end: string;
  symbol: string;
  stock_name: string;
