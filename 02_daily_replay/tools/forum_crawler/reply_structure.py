...
def clean_reply_chain(value: Any) -> list[dict[str, str]]:
    """Discard malformed legacy quote entries before they reach readers or exports."""
...
def stored_reply_structure(raw_json: str | dict[str, Any] | None, fallback_body: str) -> dict[str, Any]:
    ...
    chain = clean_reply_chain(payload.get("replyChain"))
    return {
